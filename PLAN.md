...
| `task-206` | `ms-02` | Implement Light/Dark/Custom Theme Support | Core Team | 3 | 15 | `done` | Theme customization API, CSS variables, toolbar controls, and N2N coverage merged. |
| `task-207` | `ms-02` | Implement HTML/Markdown Import-Export and RTF Load | Core Team | 3 | 15 | `done` | File import/export toolbar inputs, parsing services, and unit tests merged. |
| `task-208` | `ms-02` | Implement Table Insertion and Editing | Core Team | 4 | 20 | `done` | Table creation dialog, formatting options, DOM controls, and N2N coverage merged. |
